  ...
  <section class="slide">
    ...
    <div class="grid grid-2">
      ...
      <div class="card" style="gap: 16px; justify-content: center">
        <div class="callout">
          <b>Почему нагрузку считаем по таблице, а не по трекеру:</b> поле «Затрачено времени» в выгрузке
          суммирует списания <b>всех</b> участников задачи на одного исполнителя — по выгрузке нельзя понять, кто сколько сделал.
        </div>

        <div>
          <h3 class="card-title">Доказательство: сумма по людям = «Затрачено» в трекере</h3>
